...
def form_profile(motifs):
	...
	for i in range(0, len(motifs[0])):
		...
		a.append( occurs.count('A') / float(len(occurs)) )
		c.append( occurs.count('C') / float(len(occurs)) )
		g.append( occurs.count('G') / float(len(occurs)) )
		t.append( occurs.count('T') / float(len(occurs)) )
